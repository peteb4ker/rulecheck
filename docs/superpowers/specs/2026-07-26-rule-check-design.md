# RuleCheck — Design Spec

**Date:** 2026-07-26
**Status:** Approved by Pete (brainstorming session)
**Name:** Rule Check — public App Store name (decided at Research Gate close;
"RuleCheck" was blocked by an existing iOS app). Repo/codebase remain
"rulecheck" unless renamed later.

## What this is

RuleCheck is a free, fully offline iOS app that lets Pokemon TCG players and
...
> only), repo private until paraphrase ships, public name Rule Check. The
...
4. **Name availability.** "RuleCheck" on the App Store plus a USPTO
